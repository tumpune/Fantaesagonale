...
const inputClass =
  'w-full rounded-xl border border-white/15 bg-brand-soft px-4 py-3 text-corpo text-white transition-all duration-300 hover:border-white/25 focus:border-brand-yellow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-yellow'
      ...
      <section className="flex min-h-[70svh] items-center justify-center px-5 pb-16 pt-28 sm:px-8 sm:pt-36 bg-[radial-gradient(circle_at_20%_20%,rgba(252,215,12,0.12),transparent_45%),radial-gradient(circle_at_80%_30%,rgba(230,26,26,0.14),transparent_50%)]">
        <Reveal variant="scale" className="w-full max-w-md">
          <div className="rounded-2xl border border-white/[0.08] bg-brand-card p-6 shadow-2xl shadow-black/40 sm:p-8 lg:p-10">
            <h1 className="mb-1.5 text-center font-playfair text-titolo font-normal italic text-white">
              Area Soci
            </h1>
            <p className="mb-8 text-center text-corpo text-white/50">
            ...
            <p className="mt-5 text-center text-corpo text-white/50">
