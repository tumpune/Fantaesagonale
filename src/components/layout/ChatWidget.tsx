...
export default function ChatWidget() {
  ...
  return (
    <Link
      ...
      className={`press group fixed bottom-3 right-3 z-[90] grid h-12 w-12 place-items-center rounded-full bg-gradient-to-r from-accento-1 to-accento-2 text-black shadow-lg shadow-accento-2/40 transition-all duration-500 hover:scale-110 hover:shadow-xl hover:shadow-accento-2/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white sm:bottom-6 sm:right-6 sm:h-14 sm:w-14 ${
